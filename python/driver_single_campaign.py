...
config.dsp_l = config.cam_l[config.single_campaign]
...
config.result_file = "../results/bttt/stage-1/arbitrage.results.single." + str(cam) + ".r-%.1f.txt" % config.cpc_payoff_ratio
